...
/** Built-in site admins (Clerk user ids). Extra ids via ADMIN_USER_IDS. */
...
/** Owner or site admin may delete/moderate community content. */
export function canModerate(authorId, userId) {
  return Boolean(userId && (authorId === userId || isAdminUserId(userId)))
}
